...
const Navbar = () => {
    ...
    return (
      <Box bg={{base:"none", md: "#51546E"}} width={{base:"none", md: "20%"}} p="4">
          <Flex>
            <IconButton
              icon={<HamburgerIcon />}
              size="lg"
          ...
          <Box display={{ base: "none", md: "block" }}>
            ...
            <Box pb="24">
              <Stack fontFamily="heading" fontSize="2xl" fontWeight="medium" textAlign="left" direction="column" spacing={4} pl="8">
                <Link to="/">
